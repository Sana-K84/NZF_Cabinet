        ...
        function getPayroll() {
            document.querySelector('.right').innerHTML =
                ...
                '<div id="table"><table border="0"><tr><td colspan="2">Нараховано</td><td>Утримано</td></tr><tr><td>' + globArr.email + '</td><td>' + globArr.address.zipcode + '</td><td>' + globArr.company.bs + '</td></tr><tr><td>' + globArr.address.street + '</td><td>' + globArr.website + '</td><td>' + globArr.address.suite + '</td></tr><tr><td colspan="2">Зарплата: ' + globArr.address.geo.lat + '</td><td>' + globArr.address.city + '</td> </tr><tr><td colspan="2">Аванс: ' + globArr.address.geo.lng + '</td><td></td></tr></div></div>'
